...
namespace Celeste.Mod.SpeedrunTool.SaveLoad.RestoreActions {
    public abstract class AbstractRestoreAction {
        ...
        public virtual void CantFoundLoadedEntityInSaved(Level level, List<Entity> savedEntityList) { }
        ...
        public virtual void CantFoundSavedEntityWhenLoad(Entity loadedEntity) {
